...
const apiService = {
  ...
  getFreeCourseDetailPageTabs: (slug) => {
    return apiClient.get(
      `/courses/course-tab-entry/?course_slug=${encodeURIComponent(slug)}`
    );
  },
  getFreeCourseDetailPageWhyChooseTitle: (slug) => {
    const url = `/courses/course-why-choose-title-entry/?course_slug=${encodeURIComponent(
      slug
    )}`;
    return apiClient.get(url);
  },
  getFreeCourseDetailPageWhyChoose: (slug) => {
    return apiClient.get(
      `/courses/course-why-choose-entry/?course_slug=${encodeURIComponent(
        slug
      )}`
    );
  },
  ...
  getServiceLanguageLabListing: () => {
    return apiClient.get("/service/service-language-lab-listings/");
  },
  ...
  getServiceOurCourses: (destination_slug = null) => {
    const url = destination_slug
      ? `/service/service-destination-our-courses-listing/?destination_slug=${encodeURIComponent(
          destination_slug
        )}`
      : `/service/service-destination-our-courses-listing/`;
    return apiClient.get(url);
  },

  getServiceOurCoursesTitle: (destination_slug = null) => {
    const url = destination_slug
      ? `/service/service-destination-our-courses-title/?destination_slug=${encodeURIComponent(
          destination_slug
        )}`
      : `/service/service-destination-our-courses-title/`;
    return apiClient.get(url);
  },
};
