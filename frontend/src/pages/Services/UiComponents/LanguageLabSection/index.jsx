          ...
          <div className="w-full md:w-1/3 min-h-[150px] xs:min-h-[200px] sm:min-h-[250px] md:min-h-full flex flex-col overflow-y-auto">
            <div className="flex flex-col py-2 xs:py-3 sm:py-4 lg:py-6">
              {languageLabItems.map((item, index) => (
                ...
                >
                  <button
                    className={`w-full h-auto sm:h-auto lg:h-20 text-left px-3 xs:px-4 sm:px-5 my-2 text-xs xs:text-sm sm:text-base lg:text-lg font-medium transition-all duration-300 leading-loose ${selectedItem?.id === item.id
