...
import CountryDedicatedPage from './CountryListing/CountryDedicatedPage';

const Country = () => {
  const sections = [
    { name: 'Banner Section', component: <BannerSection /> },
    { name: 'Country Listing Section', component: <CountryListing /> },
    { name: 'Country Page Create', component: <CountryDedicatedPage /> },
  ];
