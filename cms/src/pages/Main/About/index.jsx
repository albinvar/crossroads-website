...
import TailorOurGuidance from './TailorOurGuidanceSection';
import OurValuesSection from './OurValuesSection';
import MissionVisionSection from './MissionVisionSection';
import WhyCrossroads from './WhyCrossroads';

const About = () => {
  const sections = [
    { name: 'Banner Section', component: <BannerSection /> },
    { name: 'Tailor Our Guidance Section', component: <TailorOurGuidance /> },
    { name: 'Why Crossroads Section', component: <WhyCrossroads /> },
    { name: 'Mission Vision Section', component: <MissionVisionSection /> },
