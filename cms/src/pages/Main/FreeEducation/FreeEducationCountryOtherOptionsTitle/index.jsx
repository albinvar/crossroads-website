...
import FreeEducationCountryOtherOptionsListing from '../FreeEducationCountryOtherOptionsListing';

const FreeEducationCountryOtherOptionsTitle = () => {
  ...
  const initialFields = [
    ...
    },
    {
      id: 'main_title',
      type: 'textEditor',
      label: 'Other Options Section Main Title',
      value: '',
  ...
  return (
    <div className='space-y-6'>
      <Form
        sectionName="Free Education Country Other Options Title Section"
        dataSets={[
          {
            name: 'Fields',
            fields: mainSet,
        ...
        apiEndpoint="/free-education/free-education-country-other-options-title-entry/"
        identifierField="id"
        showAddItems={true}
      />
      <FreeEducationCountryOtherOptionsListing/>
    </div>
  );
};

export default FreeEducationCountryOtherOptionsTitle;